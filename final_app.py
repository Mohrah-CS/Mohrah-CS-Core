...
st.markdown("""
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Hero Section */
    .hero {
        background: linear-gradient(135deg, #0a2e1f 0%, #0d3d2a 100%);
        color: white;
        padding: 60px 40px;
        border-radius: 20px;
        margin-bottom: 40px;
    ...
    .hero-title { font-size: 48px; font-weight: bold; margin-bottom: 15px; }
    .hero-title-ar { color: #4ade80; font-size: 32px; margin-bottom: 20px; }
    .hero-subtitle { font-size: 16px; color: #d1d5db; margin-bottom: 30px; line-height: 1.6; }
    .hero-buttons { display: flex; gap: 15px; flex-wrap: wrap; }
    .btn-primary { background: #4ade80; color: #0a2e1f; padding: 12px 30px; border-radius: 8px; border: none; cursor: pointer; font-weight: bold; font-size: 14px; transition: all 0.3s; display: flex; align-items: center; gap: 8px; }
    .btn-primary:hover { background: #22c55e; transform: translateY(-2px); box-shadow: 0 8px 16px rgba(74, 222, 128, 0.3); }
    .btn-secondary { background: transparent; color: white; padding: 12px 30px; border: 2px solid white; border-radius: 8px; cursor: pointer; font-weight: bold; font-size: 14px; transition: all 0.3s; display: flex; align-items: center; gap: 8px; }
    .btn-secondary:hover { background: rgba(255, 255, 255, 0.1); border-color: #4ade80; color: #4ade80; }
    ...
    .stat-number { font-size: 28px; font-weight: bold; color: #4ade80; margin-bottom: 10px; }
    ...
    .material-card:hover { transform: translateY(-5px); box-shadow: 0 12px 30px rgba(0, 0, 0, 0.15); }
    .material-card.os { border-top: 4px solid #c4b5fd; }
    .material-card.toc { border-top: 4px solid #86efac; }
    .material-icon {
        font-size: 48px;
        margin-bottom: 20px;
        text-align: center;
    }
    .material-card.os .material-icon { color: #a78bfa; }
    .material-card.toc .material-icon { color: #4ade80; }
    .material-title {
        font-size: 22px;
        font-weight: bold;
        color: #0a2e1f;
    ...
    .material-card.os .material-btn:hover { border-color: #a78bfa; color: #a78bfa; background: #f3e8ff; }
    .material-card.toc .material-btn:hover { border-color: #4ade80; color: #4ade80; background: #f0fdf4; }
    ...
    .used-card:hover { transform: translateY(-5px); box-shadow: 0 10px 24px rgba(0, 0, 0, 0.15); }
    .used-card-image {
        width: 100%;
        height: 150px;
        background: linear-gradient(135deg, #0a2e1f 0%, #0d3d2a 100%);
    ...
    .view-more-btn:hover { border-color: #4ade80; color: #4ade80; background: #f0fdf4; }
    ...
    @media (max-width: 1024px) {
        ...
        .most-used-grid { grid-template-columns: repeat(2, 1fr); }
    ...
    @media (max-width: 768px) {
        ...
        .most-used-grid { grid-template-columns: 1fr; }
...
if display_page == "Home Page":
    ...
    <div class="hero">
        <div class="hero-content">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                ...
                <span style="font-size: 14px; color: #d1d5db;">MOHRAH CS CORE</span>
            </div>
            <h1 class="hero-title">Mohrah <span style="color: white;">CS Core</span></h1>
            <div class="hero-title-ar">منصتك الشاملة لمواد علوم الحاسب</div>
            <p class="hero-subtitle">ملخصات مفصلة، أسئلة متنوعة، ومحاضرات موثوقة لمساعدتك على الفهم والتطبيق</p>
            <div class="hero-buttons">
                <button class="btn-primary">← تصفح المواد</button>
                <button class="btn-secondary">استكشف المنصة ⊙</button>
            </div>
        </div>
        <div class="hero-image">
            <div style="font-size: 120px; text-align: center; color: #4ade80; opacity: 0.8;">💻</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="stats-container">
        ...
        <div class="stat-box">
            ...
            <div class="stat-label">سؤال وتدريب</div>
        </div>
        <div class="stat-box">
            <div class="stat-icon">📄</div>
            <div class="stat-number">250+</div>
            <div class="stat-label">ملخص وشاتير</div>
        </div>
        <div class="stat-box">
            <div class="stat-icon">📚</div>
    ...
    <div class="announcement-banner">
        ...
        <span>إنجاز جديد: تم بحمد الله الانتهاء من إضافة كافة شباتر مادة نظم التشغيل (OS) كاملة! 🎓✨</span>
        <span style="margin-right: 20px; cursor: pointer;">عرض التفاصيل ←</span>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="text-align: center; margin-bottom: 40px;">
        <h2 class="section-title">📚 المواد النظرية</h2>
        <p class="section-subtitle">احرص على المادة التي تريد استكشافها</p>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown("""
    <div class="materials-grid">
        <div class="material-card os">
            <div class="material-icon">⚙️</div>
            <h3 class="material-title">نظم التشغيل</h3>
            <p class="material-subtitle">Operating Systems</p>
            <p class="material-description">تعلم مفاهيم نظم التشغيل وإدارة العمليات والذاكرة ونظام الملفات والمزيد.</p>
            <div class="material-stats">
                <div class="stat-item">
                    <div class="stat-item-value">1.2K</div>
                    <div class="stat-item-label">شعبية</div>
                </div>
                <div class="stat-item">
                    <div class="stat-item-value">85</div>
                    <div class="stat-item-label">أسئلة</div>
                </div>
                <div class="stat-item">
                    <div class="stat-item-value">12</div>
                    <div class="stat-item-label">ملخصات</div>
                </div>
            </div>
            <button class="material-btn">استكشاف المادة ←</button>
        </div>
        
        <div class="material-card toc">
            <div class="material-icon">🔢</div>
            <h3 class="material-title">نظرية الحوسبة</h3>
            <p class="material-subtitle">Theory of Computation</p>
            <p class="material-description">افهم أساسيات الآلات الحاسبة واللغات الرسمية والتعقيد الحسابي والرسميات.</p>
            <div class="material-stats">
                <div class="stat-item">
                    <div class="stat-item-value">980</div>
                    <div class="stat-item-label">شعبية</div>
                </div>
                <div class="stat-item">
                    <div class="stat-item-value">70</div>
                    <div class="stat-item-label">أسئلة</div>
                </div>
                <div class="stat-item">
                    <div class="stat-item-value">10</div>
                    <div class="stat-item-label">ملخصات</div>
                </div>
            </div>
            <button class="material-btn">استكشاف المادة ←</button>
    ...
    st.markdown("""
    <div style="text-align: center; margin-bottom: 40px;">
        <h2 class="most-used-title">⚙️ الأكثر استخداماً هذا الأسبوع</h2>
        <p class="section-subtitle">المواد والملخصات الأكثر زيارة من قبل الطلاب</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="most-used-grid">
        <div class="used-card">
            <div class="used-card-image">
                <span style="font-size: 60px;">OS</span>
                <div class="used-card-bookmark">📌</div>
            </div>
            <div class="used-card-content">
                <div class="used-card-title">مقدمة في نظم التشغيل</div>
                <div class="used-card-code">CIT 1404</div>
                <div class="used-card-views">👁️ 1.2K شاهد</div>
            </div>
        </div>
        ...
        <div class="used-card">
            ...
            <div class="used-card-content">
                <div class="used-card-title">عمليات المعالج</div>
                <div class="used-card-code">CIT 1404</div>
                <div class="used-card-views">👁️ 980 شاهد</div>
            </div>
        </div>
        ...
        <div class="used-card">
            ...
            <div class="used-card-content">
                <div class="used-card-title">إدارة الذاكرة</div>
                <div class="used-card-code">CIT 1404</div>
                <div class="used-card-views">👁️ 875 شاهد</div>
            </div>
        </div>
        
        <div class="used-card">
            <div class="used-card-image">
                <span style="font-size: 60px;">Σ</span>
                <div class="used-card-bookmark">📌</div>
            </div>
            <div class="used-card-content">
                <div class="used-card-title">اللغات الرسمية والأوتوماتا</div>
                <div class="used-card-code">CSC 1406</div>
                <div class="used-card-views">👁️ 755 شاهد</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="view-more-container">
        <button class="view-more-btn">عرض المزيد ⊙</button>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="footer">
        <div class="footer-content">
            <div class="footer-section">
                <div style="font-size: 20px; font-weight: bold; margin-bottom: 15px;">💎 MOHRAH CS CORE</div>
                <p style="font-size: 12px; color: #d1d5db; line-height: 1.6;">منصة تعليمية متخصصة في علوم الحاسب توفر ملخصات وتمارين وشروحات للطلاب.</p>
        ...
        <div class="footer-bottom">
            © 2024 محفوظة الحقوق - Mohrah Atiah Al-Juhani
        </div>
        <div class="footer-credit">
            صُنع بـ ❤️ بواسطة مهره عطيه الجهني
        </div>
    </div>
    """, unsafe_allow_html=True)
