...
subject = st.sidebar.selectbox(
    ...
    ["Home Page", "Foundations of TOC", "DFA Explorer", "NFA Masterclass", "Regular Expressions", "DFA to RE & Pumping Lemma", "CFG & Chomsky Form", "PDA & CFL Theory", "Turing Machines & Algorithms", "🎓 Course Completion", "Introduction to OS", "Process Management", "Memory Management", "Storage & I/O", "Contact Developer", "Community Feedback"]
)
...
elif subject == "Introduction to OS":
...
st.markdown(f"""
    <div class="footer">
        <p>©️ 2026 | <b>تطوير وبرمجة: مهره عطيه الجهني</b></p>
        <p style="font-size: 14px; opacity: 0.8; margin-top: 10px;">
            ©️ 2026 Mohrah Atiah. All rights reserved. This platform is an original academic project. 
        </p>
    </div>
    """, unsafe_allow_html=True)